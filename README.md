...
| <div style="font-size: 50px">**[SQL (Intermediate)](https://www.hackerrank.com/certificates/5e8fe7aa78c3)**</div> | An intermediate-level certification validating industry-standard SQL proficiency. Through rigorous, time-constrained challenges, it demonstrates how to write clean, optimized queries to join, filter, and aggregate complex data structures.<br><br>_Issued by HackerRank_ |
